...
import 'addmed_again_model.dart';
export 'addmed_again_model.dart';

class AddmedAgainWidget extends StatefulWidget {
  const AddmedAgainWidget({
    super.key,
    required this.medSelect,
  });

  final MedicationsRecord? medSelect;

  @override
  State<AddmedAgainWidget> createState() => _AddmedAgainWidgetState();
}

class _AddmedAgainWidgetState extends State<AddmedAgainWidget>
    with TickerProviderStateMixin {
  late AddmedAgainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddmedAgainModel());
    ...
    _model.nameDrugController ??=
        TextEditingController(text: widget.medSelect?.nameDrug);

    _model.detailController ??=
        TextEditingController(text: widget.medSelect?.detailDrug);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        int addmedAgainCount = snapshot.data!;
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Autocomplete<String>(
                                  initialValue: TextEditingValue(
                                      text: widget.medSelect!.nameDrug),
                                ...
                                Expanded(
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                      ...
                                      _model.typeDrugValue ??=
                                          widget.medSelect?.typeDrug,
                                    ),
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: FlutterFlowCountController(
                                      ...
                                      count: _model.dosageValue ??=
                                          widget.medSelect!.dosage,
